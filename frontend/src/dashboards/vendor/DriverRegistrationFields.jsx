  ...
  return (
    <>
      ...
      <Card className="space-y-4">
        ...
        <p className="text-sm text-slate-600">{t('driverRegistration.rulesIntro')}</p>
        <div className="text-sm">
          ...
          >
            {t('driverRegistration.readRules')}
          </button>
        </div>
        <label className="flex items-start gap-2 text-sm text-slate-700">
          <input
          ...
          />
          <span>{t('driverRegistration.acceptRules')}</span>
        </label>
      </Card>

      <Card className="space-y-4">
        <SectionTitle>{t('driverRegistration.section9')}</SectionTitle>
